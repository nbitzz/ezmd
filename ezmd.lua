...
if (game.PlaceId == 6839171747) then
    ...
    if (ezmd.configs.Gay) then
        ...
        ezmd.gay = {
            DoorKissVideo = ezmd.assets:Get("https://cdn.discordapp.com/attachments/985317502076739586/1019768115720101968/dfs.webm"),
        ...
        task.spawn(function()
            --[[ezmd.stats.Knobs:WaitForChild("Rooms Survived")]]ezmd.gamedata.LatestRoom.Changed:Connect(function(v) 
                ...
                if (ezmd.configs.Gay and workspace:FindFirstChild("SeekMoving") or currentRoom:FindFirstChild("FigureSetup")) then
                    ...
                    w.Playing = true
                    w.BorderSizePixel = 0
                    local u = Instance.new("UIGradient",w)
                    u.Transparency = NumberSequence.new(0.6,0.6)
